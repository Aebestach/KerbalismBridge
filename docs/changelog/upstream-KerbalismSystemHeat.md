# Upstream changelog: judicator/KerbalismSystemHeat

Historical releases before the Aebestach fork (through 0.5.0).

## Upstream changelog (judicator/KerbalismSystemHeat, through 0.5.0)

0.5.0
-----
 - Removed dynamic radioactivity feature completely (in order to fix issues with FAR and KopernicusExpansion; feature possibly would migrate to a separate mod).
 * Hopefully fixed issues #3, #4 and #8, thus making mod compatible with FAR and KopernicusExpansion. Need more testing though.
