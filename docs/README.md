...
| Section | Purpose |
|---------|---------|
| [DEVELOPER.md](DEVELOPER.md) / [DEVELOPER-CN.md](DEVELOPER-CN.md) | Build, release packaging, architecture links |
| [architecture/](architecture/) | Layer A / Layer B design rules and package layout |
