...
namespace KerbalismNFE
{
	public class NFECapacitorKerbalismUpdater : PartModule, IKerbalismModule
	{
		...
		public static string BackgroundUpdate(
			...
			double elapsed_s)
		{
			ProtoPartModuleSnapshot capacitor = KerbalismBridge.BridgeUtils.TryFindPartModuleSnapshot(part_snapshot, "DischargeCapacitor");
			if (capacitor == null)
		...
		private void RefreshPlannerIfStateChanged()
		{
			...
			bool plannerRechargeEnabled = capacitorModule.Enabled;
			...
			NFEUtils.UpdateKerbalismPlannerUI();
		}
