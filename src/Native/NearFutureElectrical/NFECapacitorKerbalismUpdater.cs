...
namespace KerbalismNative
{
	public class NFECapacitorKerbalismUpdater : PartModule, IKerbalismModule
	{
		...
		public static string brokerTitle = Localizer.Format("#LOC_KerbalismNative_Brokers_Capacitor");
		...
		public static string BackgroundUpdate(
			...
			double elapsed_s)
		{
			ProtoPartModuleSnapshot capacitor = NativeUtils.FindPartModuleSnapshot(part_snapshot, "DischargeCapacitor");
			if (capacitor == null)
		...
		private void RefreshPlannerIfStateChanged()
		{
			...
			NativeUtils.UpdateKerbalismPlannerUI();
		}
