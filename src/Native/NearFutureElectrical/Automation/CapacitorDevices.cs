...
namespace KerbalismNative
{
	public sealed class CapacitorRechargeDevice : LoadedDevice<DischargeCapacitor>
	{
		...
		public override string DisplayName => Localizer.Format("#LOC_KerbalismNative_Device_CapacitorRecharge");
	...
	public sealed class CapacitorDischargeDevice : LoadedDevice<DischargeCapacitor>
	{
		...
		public override string DisplayName => Localizer.Format("#LOC_KerbalismNative_Device_CapacitorDischarge");
